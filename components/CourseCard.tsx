...
import { MapPin, Flag, ChevronRight, ExternalLink } from "lucide-react";
  ...
  return (
    ...
    >
      <div className="flex gap-3 p-3">
        <div className="relative h-[88px] w-[88px] flex-shrink-0 sm:h-24 sm:w-24">
          ...
          <div className="mt-auto flex items-end justify-between gap-2 pt-1.5">
            <div>
              <div className="flex items-baseline gap-1">
                ...
                <span className="text-base font-extrabold leading-none text-brand-700">
      ...
      <div className="flex items-center gap-2 border-t border-gray-100 px-3 py-2">
        <Link
          ...
          className="flex flex-1 items-center justify-center gap-0.5 rounded-lg bg-brand-600 py-2 text-xs font-bold text-white transition hover:bg-brand-700"
        >
          상세보기
        ...
        <a
          ...
          onClick={(e) => e.stopPropagation()}
          className="rounded-lg border border-gray-200 px-2.5 py-2 text-[11px] font-semibold text-gray-500 transition hover:border-[#fee500] hover:bg-[#fee500]/10"
          title="카카오맵"
        >
          <ExternalLink className="mx-auto h-3.5 w-3.5" />
          <span className="mt-0.5 block text-center">카카오</span>
        </a>
        <a
          ...
          rel="noopener noreferrer"
          onClick={(e) => e.stopPropagation()}
          className="rounded-lg border border-gray-200 px-2.5 py-2 text-[11px] font-semibold text-gray-500 transition hover:border-[#03c75a] hover:bg-[#03c75a]/5"
          title="네이버지도"
        >
          <ExternalLink className="mx-auto h-3.5 w-3.5" />
          <span className="mt-0.5 block text-center">네이버</span>
        </a>
      </div>
    </article>
  );
