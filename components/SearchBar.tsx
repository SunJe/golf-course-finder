  ...
  return (
    <div className="relative w-full">
      ...
      <input
        ...
        className={`w-full rounded-full border border-gray-200 bg-white pl-12 pr-11 text-gray-900 shadow-sm outline-none transition focus:border-brand-400 focus:ring-2 focus:ring-brand-100 placeholder:text-gray-400 ${
