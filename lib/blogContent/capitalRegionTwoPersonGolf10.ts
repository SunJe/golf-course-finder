...
export const CAPITAL_REGION_TWO_PERSON_GOLF_10_POST: BlogPost = {
  ...
  thumbnail:
    "/images/blog/capital-region-two-person-golf-courses-10/capital-region-two-person-golf-courses-10-hero.webp",
  thumbnailAlt: "수도권 2인 플레이 골프장 10곳 가이드 썸네일",
  ...
  references: [
    {
      ...
      note: "공식 홈페이지·예약안내를 최우선으로 두고, 네이버·티스토리·독립 블로그에서 반복되는 후기는 ‘후기에서 반복되는 평가’로만 표현. 그린피 숫자는 시즌·요일·티오프·채널 변동이 커 본문에 고정하지 않음. 출처 매트릭스 39행(코스별 공식·후기·교차검증).",
    },
  ],
  quickConclusion: {
    title: "빠르게 고르면",
    items: [
      "둘만 단독·노캐디: 락가든 · 타이거 3부 · 드림듄스 · 포레스트힐",
      "비용 조건이 붙는 단독: 지산(평일) · 한림안성 · 라싸",
      "공지·이벤트 확인: 인서울27 · 아도니스 퍼블릭",
      "2인 예약은 되지만 단독 보장 아님: 올림픽CC 조인",
    ],
  },
  sections: [
    {
    ...
    },
    {
      heading: "10곳 한눈에 비교",
      image:
        "/images/blog/capital-region-two-person-golf-courses-10/capital-region-two-person-golf-courses-10-comparison.webp",
      imageAlt: "수도권 2인 플레이 가능한 골프장 10곳 조건 비교표",
      imageLayout: "natural",
      imageLightbox: true,
      body: [
        "그린피를 표에 고정하지 않은 이유는 시즌·요일·티오프 시간·예약 채널·인원 추가금이 자주 바뀌기 때문입니다. 최종 금액은 공식 예약창에서 확인하세요.",
      ],
      table: {
        caption: "수도권 2인 플레이 방식·캐디·핵심 조건 비교",
        columns: ["골프장", "지역", "2인 방식", "캐디", "핵심 조건"],
        rows: [
          [
            "락가든 골프클럽",
            "경기 포천",
          ...
          [
            ...
            "3부 단독 2인",
            "3부 노캐디",
            "1·2부는 4인 기준, 3부는 2~4인 자유·인원 추가금 없음",
          ],
          [
            "포레스트힐CC",
            "경기 포천",
          ...
          [
            ...
            "2·3인 공지형",
            "예약 조건 확인",
            "2026년 7월 공식 홈페이지에 2~3인 플레이 가능 공지",
          ],
          [
            "아도니스 퍼블릭",
            "경기 포천",
            "월별 이벤트 2인",
            "예약 조건 확인",
            "2026년 5·6월 조인 없는 2인 운영, 5일 전 전화예약·1인 추가요금",
          ],
          [
            "올림픽CC",
            "경기 고양",
    ...
    },
    {
      ...
      body: [
        "아래 순서는 순위가 아니라 비교 순서입니다. ‘공식’과 ‘후기에서 반복’을 분리했고, 그린피 숫자는 새로 넣지 않았습니다. 락가든·드림듄스는 GolfMap 코스 DB에 동일 명칭 항목이 없어 상세 페이지 CTA 대신 공식 예약 안내 링크만 연결했습니다.",
      ],
      items: [
        {
          title: "락가든 골프클럽",
    ...
    },
    {
      ...
      image:
        "/images/blog/capital-region-two-person-golf-courses-10/capital-region-two-person-golf-courses-10-booking-guide.webp",
      imageAlt: "단독 2인과 조인 예약을 구분하는 예약 가이드",
      imageLayout: "natural",
      imageLightbox: true,
      body: [
