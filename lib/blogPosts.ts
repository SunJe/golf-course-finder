    ...
    sections: [
        ...
        items: [
          {
            ...
            cons: [
              ...
              "GT3 등 저스핀 모델은 스윙 스피드가 낮으면 관용성이 떨어질 수 있음",
      ...
      },
      {
        ...
        body: [
          ...
          "Triple Diamond·GT3·ZXi LS 같은 ‘투어 헤드’는 스윙 스피드 95mph 이상에서 장점이 드러나는 편입니다. 속도가 낮다면 Max·GT2·G440 Max 계열을 우선 시타해 보세요.",
  ...
  },
  {
    ...
    sections: [
      ...
      },
      {
        ...
        body: [
          "LPGA 평균 드라이브 스피드는 약 94mph 전후입니다. 이 속도대에서는 10.5°~12° 로프트, 50~55g 경량 샤프트(R·L)가 흔한 조합입니다.",
