...
export const BLOG_POSTS: BlogPost[] = [
    ...
    sections: [
      {
        ...
        body: [
          ...
          "고양시 덕양·일산권에서 당일 라운드가 가능한 대표 골프장 5곳의 위치, 홀 수, 참고 요금, 연락처를 비교해 정리했습니다.",
        ],
      },
      {
        heading: "이런 분께 추천합니다",
  ...
  },
  {
    ...
    title: "입문용 아이언 추천 남자편: 국민 골프채 V300부터 일본 아이언까지",
    description:
    ...
    sections: [
      ...
      },
      {
        ...
        items: [
          {
            title: "브리지스톤 V300: 남자 입문용 아이언의 기준점",
            description:
          ...
          {
            title: "미즈노 JPX 계열: 일본 아이언 특유의 안정감과 선택 폭",
            description:
          ...
          {
            title: "야마하 인프레스 UD+2: 편하게 띄우고 거리를 얻고 싶은 사람",
            description:
  ...
  },
  {
    ...
    title: "입문용 아이언 추천 여자편: 젝시오, 핑 G Le, 온오프 중 무엇을 고를까",
    description:
      "여성 골프 입문자를 위한 아이언 추천 가이드입니다. 젝시오 레이디스, 핑 G Le, 온오프 레이디 아이언의 장단점과 중고 구매 팁을 정리했습니다.",
    category: "gear-guide",
    categoryLabel: CATEGORY_LABELS["gear-guide"],
    date: "2026-06-27",
    ...
    sections: [
      ...
      },
      {
        ...
        items: [
          {
            title: "젝시오 레이디스: 가장 무난한 여성 국민 골프채 후보",
            description:
          ...
          {
            title: "핑 G Le 계열: 가볍지만 너무 ‘시니어 느낌’은 싫다면",
            description:
          ...
          {
            title: "온오프 레이디 / 다이와 계열: 일본 감성과 가벼운 사용감을 원한다면",
            description:
