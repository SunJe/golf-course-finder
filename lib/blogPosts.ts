...
export const BLOG_POSTS: BlogPost[] = [
  ...
  },
  {
    ...
    quickConclusion: {
      title: "저렴하게 보이는 요금 ≠ 최종 비용",
      items: [
        "그린피: 주중·주말·새벽·야간·시즌에 따라 실제 예약가가 달라집니다",
        "카트비·캐디피: 그린피와 별도인 경우가 많아 1인 총액으로 비교해야 합니다",
        "노캐디·셀프 여부: 가능하면 비용을 줄일 수 있지만 운영일·시간대 제한이 있을 수 있습니다",
        "조인·식음 비용: 1인 조인 가능 여부와 클럽하우스 식음 비용까지 확인하면 예산 차이가 줄어듭니다",
      ],
    },
    sections: [
      {
        ...
        body: [
          ...
          "표시 요금은 참고용이며, 실제 예약가·카트비·캐디피는 별도일 수 있습니다. 특히 “그린피만 저렴한 곳”과 “카트비·캐디피까지 합쳐도 부담이 적은 곳”은 다를 수 있으니 최종 1인 비용 기준으로 비교하는 것이 좋습니다.",
        ],
      },
      {
        heading: "이런 분께 추천합니다",
        ...
        items: [
          {
            title: "파주제이퍼블릭골프클럽",
            description:
              "6홀 대중제 코스로 같은 코스를 반복해 짧게 라운드하는 구조라 18홀 풀코스보다 시간·체력·비용 부담을 줄이기 좋습니다. 서울 서북부에서 당일 이동이 가능하고, 첫 필드 전 실전 감각만 가볍게 확인하려는 골퍼에게 맞습니다.",
            relatedCourseId: "gc-81becbdb274e",
          },
          {
            title: "남양주CC",
            description:
              "9홀 대중제 코스로 18홀보다 라운드 시간이 짧아 평일 반나절 일정으로 비교하기 좋습니다. 서울 동북부·남양주권 접근성이 좋아 이동 비용까지 함께 줄이고 싶은 경우 후보가 됩니다.",
            relatedCourseId: "gc-29fa36946d15",
          },
          {
            title: "골프존카운티 송도",
            description:
              "인천 연수구 18홀 대중제 코스로 참고 요금 하한이 비교적 낮게 잡혀 있는 편입니다. 서울 남부·인천권 거주자는 이동 시간을 줄일 수 있어, 그린피뿐 아니라 교통비와 일정 부담까지 함께 비교하기 좋습니다.",
            relatedCourseId: "gc-4005648f63d2",
          },
          {
            title: "일산스프링힐스 컨트리클럽",
            description:
              "고양시 9홀 대중제 코스입니다. 일산·서울 서북부에서 이동 거리가 짧고 9홀 중심으로 운영되어 시간 비용을 줄이기 좋습니다. 예약 전 18홀 운영 방식, 카트비·캐디피 포함 여부를 함께 확인하세요.",
  ...
  },
  {
    ...
    title: "고양 골프장 BEST 5 추천: 고양CC, 한양파인CC, 스프링힐스CC 비교",
    description:
      "고양 골프장을 찾는 분들을 위해 고양CC, 한양파인CC, 일산스프링힐스, 123골프클럽, 올림픽CC의 위치, 코스 특징, 예약 전 확인할 점을 정리했습니다.",
    category: "course-guide",
    categoryLabel: CATEGORY_LABELS["course-guide"],
    date: "2026-06-29",
    ...
    quickConclusion: {
      title: "빠른 결론",
      items: [
        "서울 서북권 접근성을 우선하면: 고양CC, 한양파인CC",
        "짧은 9홀 라운드를 원하면: 일산스프링힐스, 한양파인CC",
        "가볍게 6홀 실전 감각을 보고 싶다면: 123골프클럽",
        "전장이 있는 9홀 2바퀴형 코스를 찾는다면: 올림픽CC",
        "고양 골프장은 9홀·6홀 코스가 많아 예약 방식과 18홀 운영 여부를 꼭 확인하는 것이 좋습니다",
      ],
    },
    sections: [
      {
        ...
        body: [
          "고양시는 서울 서북권과 가까워 은평·마포·강서·일산권에서 가볍게 라운드를 계획하기 좋은 지역입니다. 특히 9홀 퍼블릭, 짧은 코스, 연습장 연계형 골프장, 야간 라운드 가능 여부를 함께 볼 수 있어 초보자와 직장인 라운드 수요가 꾸준합니다.",
          "고양 골프장은 서울과 가깝다는 점이 가장 큰 장점입니다. 은평구, 마포구, 서대문구, 강서구, 일산권에서 이동하기 편하고, 18홀 정규 골프장보다 짧게 다녀올 수 있는 9홀·6홀 코스도 많습니다. 그래서 “처음 필드 연습을 하고 싶은 사람”, “퇴근 후 짧게 라운드를 돌고 싶은 사람”, “서울 근교에서 예약 가능한 곳을 찾는 사람”에게 자주 언급됩니다.",
          "다만 고양 골프장은 코스 성격이 꽤 다릅니다. 어떤 곳은 전장이 짧고 실전 연습에 가깝고, 어떤 곳은 9홀을 두 바퀴 도는 방식으로 운영됩니다. 또 일부 코스는 폭이 좁거나 진행이 밀린다는 후기도 있어, 단순히 거리만 보고 선택하기보다 코스 난이도와 예약 방식, 카트·캐디 운영을 함께 확인하는 것이 좋습니다.",
        ],
      },
      {
        heading: "고양 골프장 BEST 5",
        body: [
          "GolfMap 등록 데이터와 공개 후기, 공식 홈페이지 정보를 바탕으로 고양에서 많이 찾는 골프장 5곳을 정리했습니다.",
        ],
        items: [
          {
            title: "고양CC",
            description:
              "고양CC는 고양시 덕양구에 위치한 퍼블릭 골프장으로, 서울 서북권에서 접근성이 좋은 코스로 자주 언급됩니다. 공식 홈페이지에서도 골프장 이용과 골프연습장 이용을 함께 안내하고 있어, 라운드와 연습을 같이 고려하는 골퍼가 참고하기 좋습니다.\n\n후기들을 보면 고양CC는 9홀 퍼블릭 코스로 부담 없이 다녀올 수 있다는 장점이 자주 나옵니다. 서울 은평·강북권에서 비교적 가까워 이동 부담이 적고, 야간 라운드 가능 여부를 함께 보는 분들에게도 후보가 됩니다. 다만 9홀 퍼블릭 특성상 컨디션이나 진행 속도, 잔디 관리에 대한 평가는 시기마다 다를 수 있으므로 최근 후기를 확인하는 것이 좋습니다.",
            recommendationReasons: [
              "서울 서북권에서 접근성이 좋은 고양시 골프장",
              "9홀 퍼블릭 코스로 짧은 라운드 계획에 적합",
              "연습장과 함께 확인하기 좋은 구조",
              "초보자부터 재방문 골퍼까지 비교적 부담 없이 고려 가능",
            ],
          ...
          },
          {
            title: "한양파인CC",
            description:
              "한양파인CC는 고양시 덕양구에 위치한 9홀 퍼블릭 골프장입니다. 서울 근교 접근성이 좋아 고양·은평·일산권에서 많이 찾는 코스 중 하나입니다. 공식 홈페이지에는 예약, 코스 안내, 골프연습장, 시설 안내가 따로 구성되어 있어 방문 전 정보를 확인하기 쉽습니다.\n\n후기에서는 접근성, 연습장 연계, 비교적 깔끔한 관리가 장점으로 언급됩니다. 일부 후기에서는 전장이 짧은 편이라는 평가도 있어, 장타자보다는 실전 감각을 점검하거나 짧은 라운드를 원하는 골퍼에게 더 잘 맞을 수 있습니다. 처음 고양권 골프장을 비교한다면 고양CC와 함께 자주 후보에 오르는 곳입니다.",
            recommendationReasons: [
              "서울 근교에서 접근하기 좋은 고양시 9홀 코스",
              "연습장과 코스 이용을 함께 고려하기 좋음",
              "짧은 라운드나 9홀 2바퀴 운영을 확인하기 좋은 후보",
              "고양CC, 스프링힐스와 함께 비교하기 쉬움",
            ],
          ...
          },
          {
            title: "일산스프링힐스CC",
            description:
              "일산스프링힐스CC는 고양시 덕양구 주교동·산황동 일대에 위치한 9홀 퍼블릭 골프장입니다. 공개 정보 기준으로 9홀/36파 규모로 소개되며, 공식 홈페이지에서는 실시간 예약과 코스 이용 안내를 제공하고 있습니다.\n\n후기에서는 가성비와 접근성이 장점으로 언급되는 편입니다. 다만 일부 커뮤니티 후기에서는 홀 간격이 좁아 옆 홀 공을 신경 써야 한다는 의견도 있습니다. 즉, 편하게 짧은 라운드를 계획하기에는 좋지만, 처음 방문한다면 안전과 진행 흐름을 신경 쓰는 것이 좋습니다.",
            recommendationReasons: [
              "9홀 퍼블릭으로 짧은 라운드 계획에 적합",
              "고양권에서 비교적 실용적인 선택지",
              "공식 홈페이지 예약 동선을 확인하기 쉬움",
              "초보자도 실전 감각을 익히기 좋은 코스 후보",
            ],
            relatedCourseId: "gc-41b5c15f44da",
            imageCredit: VISIT_KOREA_IMAGE_CREDIT,
          },
          {
            title: "123골프클럽",
            description:
              "123골프클럽은 고양시 덕양구 통일로에 있는 6홀 규모의 퍼블릭 골프장입니다. 짧은 코스지만 실전 감각을 익히기 좋고, 가볍게 라운드를 경험하고 싶은 골퍼에게 후보가 됩니다. 공식 홈페이지에서도 6홀 경기 기준 시간과 코스 공략 정보를 안내하고 있습니다.\n\n특히 123골프클럽은 “한국 최초의 퍼블릭 골프장”으로 소개되는 자료가 있어 역사성이 있는 코스로도 언급됩니다. 6홀이라는 특성상 정규 18홀 라운드와는 다르지만, 처음 필드 분위기를 경험하거나 짧게 실전 감각을 확인하려는 분에게는 매력적인 선택지가 될 수 있습니다.",
            recommendationReasons: [
              "6홀 규모로 짧고 가볍게 실전 라운드 가능",
              "고양 덕양구에서 접근성 좋은 퍼블릭 코스",
              "첫 필드 연습이나 짧은 라운드 경험에 적합",
              "역사성이 있는 고양권 골프장 후보",
            ],
          ...
          },
          {
            title: "올림픽CC",
            description:
              "올림픽CC는 고양시 덕양구 벽제동에 위치한 퍼블릭 골프장입니다. 공개 정보 기준으로 9홀/36파 규모로 안내되며, 강북권과 일산권에서 접근하기 좋은 도심 근거리 골프장으로 소개됩니다. 일부 관광 정보에서는 전 홀 라이트 시설을 갖춰 출퇴근 골프가 가능하다는 점도 언급됩니다.\n\n후기에서는 전장이 있는 편이고 조인 예약이 비교적 편하다는 의견도 보입니다. 반면 일부 후기에서는 시설, 진행 속도, 가격 대비 만족도에 대한 아쉬움도 있어 방문 전 최근 후기를 확인하는 것이 좋습니다. 고양권에서 9홀 2바퀴형 라운드를 고려한다면 함께 비교해볼 수 있는 골프장입니다.",
            recommendationReasons: [
              "고양 벽제권에서 접근 가능한 9홀 퍼블릭 코스",
              "강북권·일산권에서 이동을 고려하기 좋은 위치",
              "야간 라운드 가능 여부를 확인해볼 만한 골프장",
              "전장이 있는 9홀 2바퀴형 코스를 찾는 분에게 후보",
            ],
            relatedCourseId: "gc-18640b625b94",
            imageCredit: VISIT_KOREA_IMAGE_CREDIT,
          },
      ...
      {
        heading: "고양 골프장을 고를 때 보는 기준",
        body: [
          "고양 골프장을 선택할 때는 단순히 집에서 가까운지보다 아래 기준을 함께 보는 것이 좋습니다.",
          "첫째, 홀 수입니다. 고양 지역은 9홀, 6홀 코스가 많아 정규 18홀 느낌을 원하는지, 짧은 라운드 경험을 원하는지에 따라 선택이 달라집니다.",
          "둘째, 접근성입니다. 은평·마포·서대문·강서·일산권에서는 이동 시간이 짧을 수 있지만, 출퇴근 시간대에는 고양 덕양구 방향 도로가 밀릴 수 있습니다.",
          "셋째, 예약 방식입니다. 일부 골프장은 홈페이지 예약, 조인, 현장 이용 등 방식이 다를 수 있습니다. 처음 방문한다면 전화나 공식 홈페이지로 운영 방식을 확인하는 것이 안전합니다.",
          "넷째, 코스 성격입니다. 짧고 좁은 9홀 코스는 실전 연습에는 좋지만, 공을 잃어버리거나 옆 홀을 신경 써야 하는 경우도 있습니다. 초보자는 공을 넉넉히 챙기고 진행 속도를 지키는 것이 중요합니다.",
        ],
      },
      {
        heading: "관련 링크",
      ...
      },
      {
        heading: "결론",
        body: [
          "고양 골프장은 서울 서북권에서 접근성이 좋고, 9홀·6홀 퍼블릭 코스가 많아 가볍게 라운드를 계획하기 좋은 지역입니다. 고양CC와 한양파인CC는 서울 근교 접근성으로 많이 비교되고, 일산스프링힐스는 9홀 실전 라운드 후보로, 123골프클럽은 짧은 6홀 경험형 코스로, 올림픽CC는 9홀 2바퀴형 라운드 후보로 볼 수 있습니다.",
  ...
  },
  {
    ...
    description:
      "PGA 투어에서 많이 보이는 드라이버 브랜드를 초보자 관점에서 해석했습니다. 프로가 쓰는 이유와 아마추어가 조심할 점을 함께 정리했습니다.",
    category: "gear-guide",
    categoryLabel: CATEGORY_LABELS["gear-guide"],
    date: "2026-06-20",
    ...
    sections: [
      {
        ...
        body: [
          ...
          "아래는 특정 모델 구매 권유가 아니라, 투어에서 검증된 브랜드별 특성을 이해하고 본인 스윙·예산에 맞는 선택을 돕기 위한 가이드입니다. 투어 사용 비율은 시즌·대회마다 변동될 수 있으며, 초보자는 프로가 쓰는 저스핀 헤드보다 관용성 높은 Max 계열부터 비교하는 편이 안전합니다.",
        ],
      },
      {
        heading: "이런 분께 추천합니다",
    ...
    sections: [
      {
        ...
        body: [
          ...
          "여자 프로는 평균 드라이브 비거리가 남자보다 짧아, 관용성 있는 Max·고로프트(10.5°~12°)·가벼운 샤프트(50~60g) 조합이 흔합니다. 다만 이 역시 선수별 피팅 결과이므로, 여성 초보자는 LPGA 브랜드를 그대로 따라가기보다 공이 뜨는지, 샤프트가 버거운지, 슬라이스가 커지는지를 먼저 봐야 합니다.",
        ],
      },
      {
        heading: "이런 분께 추천합니다",
