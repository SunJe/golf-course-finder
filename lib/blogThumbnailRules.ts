...
export const BLOG_THUMBNAIL_FILE_BY_SLUG: Record<string, string> = {
  ...
  "seoul-nine-hole-beginner-golf-top-5": "seoul-nine-hole-8-thumbnail.png",
  ...
  "paju-golf-courses-6": "paju-golf-courses-6-thumbnail.png",
...
export const BLOG_THUMBNAIL_ALT_BY_SLUG: Record<string, string> = {
  ...
  "seoul-nine-hole-beginner-golf-top-5": "서울 근교 9홀 골프장에서 두 골퍼가 라운드하는 일러스트",
  ...
  "paju-golf-courses-6": "파주 대중제 골프장 6곳 비교 대표 이미지",
